...
//altsyncram CLOCK_ENABLE_INPUT_A="BYPASS" CLOCK_ENABLE_OUTPUT_A="BYPASS" DEVICE_FAMILY="Cyclone V" ENABLE_RUNTIME_MOD="NO" NUMWORDS_A=1024 OPERATION_MODE="SINGLE_PORT" OUTDATA_ACLR_A="NONE" OUTDATA_REG_A="CLOCK0" POWER_UP_UNINITIALIZED="FALSE" read_during_write_mode_port_a="DONT_CARE" WIDTH_A=64 WIDTH_BYTEENA_A=1 WIDTHAD_A=10 address_a clock0 data_a q_a rden_a wren_a
...
module  config_ram_in_altsyncram
	( 
	address_a,
	clock0,
	data_a,
...
endmodule //config_ram_in_altsyncram
//VALID FILE
...
`endif
	...
	config_ram_in_altsyncram	config_ram_in_altsyncram_component (
				.address_a (address),
				.clock0 (clock),
				.data_a (data),
				.rden_a (rden),
